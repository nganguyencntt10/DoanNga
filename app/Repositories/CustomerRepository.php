...
class CustomerRepository extends BaseRepository implements RepositoryInterface
{
    ...
    public function getInfo($id){
        $customer_info = $this->model->with('customer_detail')->where('id', '=', $id)->first();
        return [
            'id'        => $customer_info->id,
            'name'      => $customer_info->customer_detail->name,
            'telephone' => $customer_info->customer_detail->telephone,
            'address'   => $customer_info->customer_detail->address,
            'avatar'    => $customer_info->customer_detail->avatar,
        ];
    }
