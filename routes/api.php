...
Route::prefix('serviceprocedure')->group(function () {
	...
	// lấy ra 1 dịch vụ
	Route::get('/getone/{id}', 'Admin\ServicesController@getoneprocedure')->name('admin.serviceprocedure.getone');
});
...
Route::prefix('bookingvip')->group(function () {
	// lấy ra tất cả phòng
	Route::get('/getall', 'Admin\BookingvipController@getAll')->name('admin.bookingvip.getall');
});
